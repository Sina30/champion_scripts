...
RMenu.Add('Menu', 'main', RageUI.CreateMenu("Inventar", "Menu"))
RMenu.Add('Menu2', 'main2', RageUI.CreateMenu("Inventar", "Menu2"))
...
AddEventHandler('esx:opendingmenu2', function(item)
	--print(item.name)
	RageUI.Visible(RMenu:Get('Menu2', 'main2'), not RageUI.Visible(RMenu:Get('Menu2', 'main2')))
	dasding = item
end)
	...
	Citizen.CreateThread(function()
		while (true) do
			Citizen.Wait(1.0)
			RageUI.IsVisible(RMenu:Get('Menu', 'main'), function()
	...
	Citizen.CreateThread(function()
		while (true) do
			Citizen.Wait(1.0)
			RageUI.IsVisible(RMenu:Get('Menu2', 'main2'), function()
				RageUI.Button('Geben', nil, {  }, true, {
					onSelected = function()
						local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
