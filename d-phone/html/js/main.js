...
let champion1 = 'https://cdn.discordapp.com/attachments/852939253252227172/874333880709181460/img.png'
let champion2 = 'https://cdn.discordapp.com/attachments/852939253252227172/874336057192251465/img2.png'
...
$(function() {
    ...
    window.addEventListener("message", function(event) {
        ...
        } else if (item.action == "updateprofilapp") {
            $(".phoneprofilvorname").text(item.vorname);
            $(".phoneprofilnachname").text(item.nachname);
            $(".phoneprofilnummer").text(item.nummer);
            $(".phoneprofilfraktion").text(item.fraktion);
            $(".phoneprofilfraktionr").text(item.fraktionr);
            $(".phoneprofilgwd").text(item.gwd);
        }
    });
...
$(document).on('click', '.phone-application', function(e) {
    ...
    if (PressedApplication == "settings") {
    ...
    } else if (PressedApplication == "profil") {
        $(".phone-applications").hide();
        $(".phone-profil").fadeIn(250);
        ...
        $(".phone-applications").hide();
        $(".phone-garage").fadeIn(250);
    } else if (PressedApplication == "gps") {
        $(".phone-applications").hide();
        $(".phone-gps").fadeIn(250);
...
$(document).on('click', '#savewallaper', function() {
    $(".phone-settings-wallpaper ").fadeOut(250);
});
...
function change1() {
    document.getElementById("namewallaper").innerHTML = "Champion";
    $('.phone-background').css('background-image', 'url(' + champion1 + ')');
    $('.phone-settings-wallpaper ').css('background-image', 'url(' + champion1 + ')');
    sendData("changewallpaperOne", {});
}

function change2() {
    document.getElementById("namewallaper").innerHTML = "Champion2";
    $('.phone-background').css('background-image', 'url(' + champion2 + ')');
    $('.phone-settings-wallpaper ').css('background-image', 'url(' + champion2 + ')');
    sendData("changewallpaperTwo", {});
}
...
function loadBusiness(item) {
    ...
    businessicon = true
    document.getElementById("businessicon").style.backgroundColor = " #111";
}
...
/* GPS */
$(document).on('click', '#phone-gps-md', function() {
    sendData("setPosMD", {})
});

$(document).on('click', '#phone-gps-pd', function() {
    sendData("setPosPD", {})
});

$(document).on('click', '#phone-gps-schlepp', function() {
    sendData("setPosSchlepp", {})
});

$(document).on('click', '#phone-gps-lsc', function() {
    sendData("setPosLSC", {})
});


$(document).on('click', '#phone-gps-casino', function() {
    sendData("setPosCasino", {})
});

$(document).on('click', '#phone-gps-phone', function() {
    sendData("setPosPhone", {})
});
...
$(document).on('click', '#phone-garage-return', function() {
    $(".phone-garage").hide();
    $(".phone-applications").fadeIn(250);
});
/* Radio */
...
function Darkmode() {
    ...
    $(".phone-settings-selection").addClass('darkphone-settings-selection');
        ...
        /* Settings App */
        $(".phone-profil").addClass('darkmode');
        $(".phone-profil-header").addClass('darkmodeheader')
        $(".phone-profil-selection").addClass('darkphone-profil-selection');
...
function Whitemode() {
    ...
    $(".phone-settings-selection").removeClass('darkphone-settings-selection');
        ...
        /* Settings App */
        $(".phone-profil").removeClass('darkmode');
        $(".phone-profil-header").removeClass('darkmodeheader')
        $(".phone-profil-selection").removeClass('darkphone-profil-selection');
