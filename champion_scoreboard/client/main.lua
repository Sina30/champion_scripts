...
Citizen.CreateThread(function()
	...
	Citizen.Wait(2000)
	ESX.TriggerServerCallback('champion_scoreboard:getConnectedPlayers', function(connectedPlayers)
...
Citizen.CreateThread(function()
	...
	SendNUIMessage({
		...
		maxPlayers = GetConvarInt('sv_maxclients', 512),
		uptime = ajdik,
	})
end)

RegisterNetEvent('champion_scoreboard:updateConnectedPlayers')
AddEventHandler('champion_scoreboard:updateConnectedPlayers', function(connectedPlayers)
	UpdatePlayerTable(connectedPlayers)
end)

RegisterNetEvent('champion_scoreboard:updatePing')
AddEventHandler('champion_scoreboard:updatePing', function(connectedPlayers)
	SendNUIMessage({
		action  = 'updatePing',
...
RegisterNetEvent('champion_scoreboard:toggleID')
AddEventHandler('champion_scoreboard:toggleID', function(state)
	if state then
		idVisable = state
	else
