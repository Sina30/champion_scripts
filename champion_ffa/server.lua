...
AddEventHandler('killed', function (killer)
    ...
    if killer ~= nil then
        ...
        TriggerClientEvent("champion:notify", 'FFA', 'Du hast ' .. xSource.getName() .. ' getötet', "white", 3500)
        TriggerClientEvent('heal', killer)
        TriggerClientEvent('suckdick:addKill',killer)  
        TriggerClientEvent("champion:notify", 'FFA', 'Du wurdest von ' .. xPlayer.getName() .. ' getötet', "white", 3500)
    end
